		...
		<EmptySection>
			...
			<div className='max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4 mb-10 px-4'>
				...
				<div className='flex flex-col justify-center items-center space-y-4'>
					<h1 className='font-bold text-center justify-top text-2xl '>
						Get to know me!
					</h1>
					<div className='text-center space-y-4 max-w-xl'>
						...
						<p>
							...
							grow. If you have a good opportunity that matches my skills then don't hesitate to contact me.
						</p>
				...
				<div className='flex flex-col items-center justify-self-center justify-top space-y-4 max-w-md mb-24'>
					<div className='font-bold text-center text-2xl pt-6  lg:pt-0'>
						My Skills
					</div>
					<div className='flex flex-wrap justify-center items-center gap-2 max-w-sm'>
						...
						<Chip className='bg-gray-200 text-black rounded-lg'>
							JavaScript
						</Chip>
