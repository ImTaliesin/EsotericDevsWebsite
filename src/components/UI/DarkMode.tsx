...
export default function DarkModeToggle() {
	...
	return (
		<button
			onClick={toggleTheme}
			className=' z-50 fixed bottom-28 right-2.5 flex justify-center items-center h-10 w-16 overflow-hidden transition-all duration-200 hover:text-white hover:shadow-violet-700'>
			{ThemeIcon}
		</button>
	);
}
